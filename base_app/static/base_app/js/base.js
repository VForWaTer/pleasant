...
function search_open(){
	if (!document.getElementById("search_box")){
		...
		searchBox.outerHTML = "<a class='respo-hover-none' style='height:10px' id='search_box'><input type='search' value='' placeholder='Search ...' style='height:10px; font-size:75%;'></a>";
