...
function search_open(){
	if (!document.getElementById("search_box")){
		...
		searchBut.outerHTML = "<a href='#' class='respo-hover-white' style='height:0px' id='search_but' onclick='search_close()'><i class='fa fa-search fa-fw'></i></a>";

		var closeBut = document.getElementById("srch_close_but");
		closeBut.outerHTML = "<a href='javascript:void(0)' class='respo-hover-white' style='height:0px' id='search_close_but' onclick='search_close()'><i class='fa fa-remove fa-fw'></i></a>";
	}
}
